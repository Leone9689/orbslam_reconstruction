...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               OnlineFusionViewerManipulated* fViewer, Map* map, ORBVocabulary* voc):mSensor(sensor),mbReset(false),mbActivateLocalizationMode(false),
		      	   mbDeactivateLocalizationMode(false)
{
    ...
    mfViewer = fViewer;//new Viewer(strSettingsFile);
    /*
    bool bMapLoad;
    map = new Map(); 
    if(mapName != "none")    
...
void System::Initialize(bool pMapLoad,string pMapName)
{
    ...
    //Initialize the Tracking thread
    //(it will live in the main thread of execution, the one that called this constructor)
    mpTracker = new Tracking(this, mpVocabulary, mpMap,mfViewer, mpKeyFrameDatabase, settingsFile, mSensor);
